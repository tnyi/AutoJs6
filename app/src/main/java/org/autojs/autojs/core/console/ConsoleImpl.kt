...
open class ConsoleImpl(val uiHandler: UiHandler) : AbstractConsole() {
    ...
    override fun println(level: Int, charSequence: CharSequence): String? {
        ...
        sGlobalLogCallback?.let {
            ...
            it.onLog(levelStr, charSequence.toString())
        }
    ...
    companion object {
        ...
        private var sGlobalLogCallback: LogCallback? = null
        
        @JvmStatic
        fun setGlobalLogCallback(callback: LogCallback?) {
            Log.d(TAG, "setGlobalLogCallback: $callback")
            sGlobalLogCallback = callback
        }
        
        @JvmStatic
        fun getGlobalLogCallback(): LogCallback? {
            return sGlobalLogCallback
        }
